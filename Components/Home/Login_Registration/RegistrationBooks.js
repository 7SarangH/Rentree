        ...
        <div>
            ...
            <div class="row first-row col-lg-12" >
                ...
                <div class="container col-lg-5 p-5" >
                    ...
                    <div >Simple steps to rent a product and have cost efficient experience</div>

                </div>
                <div class="container col-lg-5 p-5">
                    <img  class ="shadow" src="https://images.pexels.com/photos/2067569/pexels-photo-2067569.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Image here" /> 
                </div> 
                <div class="container col-lg-1"></div>
            </div>
...
export default RegistrationBooks;